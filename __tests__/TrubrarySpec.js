...
it('Trubrary renders correctly, (no redux store)', () => {
  renderer.create(<Trubrary videoData={initialStoreState.resourcesData.youTubeResources} onlineMediaContent={initialStoreState.resourcesData.onlineMediaContent}
  webResources={initialStoreState.resourcesData.webResources} />);
});
