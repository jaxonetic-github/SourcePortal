...
import {
  ...
  deleteEventRequest,
  updateEventRequest,
} from './src/components/Event/Redux/Actions/eventActions.js';
...
import {
  ...
  COMMON_ICON_STYLE_SILVER,
  ROUTE_PROFILE_VIEW,
  ROUTE_EVENT_VIEW,
  ROUTE_YOUTUBELIST_VIEW,
  ROUTE_ROOT,
  ROUTE_HOME,
  ROUTE_ACTIVITIES,
  ROUTE_TRUBRARY,
...
const rootReducer = combineReducers({
  ...
  videoMediaPromotions: videoRefsReducer,
});
...
function CustomDrawerContent(props) {
  customProps = {
    ...props,
    labelStyle: styles.customDrawerLabelStyle,
    activeBackgroundColor: 'silver',
    inactiveBackgroundColor: 'white',
    style: {backgroundColor: COMMON_DARK_BACKGROUND},
  };
  return (
    <DrawerContentScrollView {...customProps}>
      <DrawerItem
        ...
        onPress={() => {
          props.navigation.navigate('ProfileComponent', {
            profileIndex: 1,
            role: 1,
            profile: initialStoreState.profiles.profiles['1'],
      ...
      <DrawerItem
        ...
        label="Event"
        onPress={() => {
          props.navigation.navigate('EventComponent', {
            eventID: 1,
            isNewEvent: false,
            role: 1,
            eventObj: initialStoreState.events.events['1'],
            updateEventRequest: updateEventRequest,
            addEventsToLocal: addEventsToLocal,
