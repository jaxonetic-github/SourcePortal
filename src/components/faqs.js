...
class Faqs extends React.Component {
  ...
  _signUp = () => {
    ...
    try {
      ...
      console.log(
        'TODO: Properly handle or log this login attempt error.',
        err,
      );
    }
  };
          ...
          <Card>
            <CardItem>
              ...
              <View
                ...
                <Text>item.item.titlesertima</Text>
              </View>
              <View
                style={{
                  padding: 5,
                ...
                <Text>item.item.titleDrJeffries</Text>
              </View>
            </CardItem>
          </Card>
          ...
          <Card>
            <CardItem>
              ...
              <View
                ...
                <Text>item.item.titlebrKabahiwatha</Text>
              </View>
              <View
                style={{
                  padding: 5,
                ...
                <Text>item.item.titledanareynolds</Text>
              </View>
            </CardItem>
            <CardItem />
          </Card>
