...
class DetailView extends Component {
  constructor(props) {
    ...
    this.state = {
      profileIndex: this.props.navigation.state.params.id,
      text: '',
    };
  }
        ...
        <Content>
          <Card style={{flex: 0}}>
            <CardItem>
              <Left>
                <Thumbnail
                  source={this.props.profiles[this.state.profileIndex].imageURI}
                />
                <Body>
                  <Text>
                    {this.props.profiles[this.state.profileIndex].name}
                  </Text>
                  <Text>
                    {this.props.profiles[this.state.profileIndex].phone}
                  </Text>
                  <Text>
                    {this.props.profiles[this.state.profileIndex].email}
                  </Text>
