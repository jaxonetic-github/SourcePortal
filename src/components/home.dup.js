...
import {
  ...
  TEXT_WHATS_GOING_ON,
  COMMON_ICON_STYLE,
  COMMON_ICON_STYLE_MAROON,
  COMMON_ICON_STYLE_GOLD,
  COMMON_LISTVIEW_ITEM_SEPARATOR,
  ICON_IOS_INFORMATION,
  ICON_ANDROID_INFORMATION,
  iconManager,
  header,
  commonViewButton,
} from '../constants.js';
...
moundBuilders=()=>(<View><Card><CardItem>
          <View style={{alignItems: 'center', margin: 5}}>
            <Image
              ...
              source={{
                uri:
                  'https://dasg7xwmldix6.cloudfront.net/episodes/521925_fDB81ij7.jpg',
              }}
            />
            <Thumbnail
            ...
            <Text>
              The Thinktanks to looking out for us. Learn about Dr Claud
              Anderson and how to build and keep wealth in the community.
            </Text>
          </View>
        </CardItem>
      </Card>
      ...
      <Card>
        <CardItem>
          <TouchableOpacity style={{position: 'absolute', top: 5, right: 0}}>
            <Icon
              ios={ICON_IOS_INFORMATION}
              android={ICON_ANDROID_INFORMATION}
              style={COMMON_ICON_STYLE}
            />
          </TouchableOpacity>
          <View style={{alignItems: 'center', margin: 5}}>
            <Thumbnail
              ...
              source={{
                uri:
                  'https://s3-us-west-1.amazonaws.com/secretenergy-2019/wp-content/uploads/2018/11/secret-energy-banner-8.jpg',
              }}
            />
  ...
  quoteCard = () => (
    <Card>
      <CardItem>
        <Text>
          “When I read history, I cannot read it as the conquerer, I must read
          it as the conquered; therefore, I have to read history as it affects
          me. I have to put myself as the centroid figure, and how does that
          history affect me.Therefore the solution must come up in my
          perspective not in the conquerers perspective.”{' '}
        </Text>
      </CardItem>
      <CardItem>
        <TouchableOpacity style={{top: 5, right: 0}}></TouchableOpacity>
  ...
  videoReferences = (promotions) => {
    const innerViews = promotions.map((promotion, i) => (
      <View key={i} style={styles.videoRefsInnerView}>
        ...
        <TouchableOpacity>
          <Thumbnail
            style={styles.videoRefsThumbnail}
    ...
    return (
      <Card style={{flex: 1}}>
        <CardItem>
          <View style={styles.videoRefsOuterStyle}>{innerViews}</View>
        </CardItem>
      </Card>
    );
  };
   ...
   */
  pastPresentFutureComponent = (digitalResources) => (
    <Card style={{flex: 1}}>
      <CardItem>
        <Text>
          Our Story... Truth, These videos are priceless, Buy them, watch them,
          gift them, watch them again!!!
        </Text>
      </CardItem>
      <CardItem>
...
const mapStateToProps = (state) => ({
  digitalResources: state.resourcesData.digitalResources,
